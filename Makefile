...
SOURCES =  mzapo_phys.c mzapo_parlcd.c serialize_lock.c display_utils.c knob.c snake_food.c snake.c text_render.c led_utils.c menu.c main.c game.c
# SOURCES =  mzapo_phys.c mzapo_parlcd.c serialize_lock.c test.c
#SOURCES += font_prop14x16.c font_rom8x16.c
TARGET_EXE = main
# TARGET_IP ?= 192.168.223.163
# edit the TARGET_IP variable to match the IP address of the board
TARGET_IP=192.168.223.116
ifeq ($(TARGET_IP),)
