...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c display_utils.c knob.c snake_food.c snake.c #game_graphics.c game.c menu_graphics.c menu.c text_render.c
